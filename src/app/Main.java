...
//        List<Node> path = aS.findPath(mappedNodes.get("GHALL002L1"), mappedNodes.get("GHALL006L1"));
        ...
        DatabaseParser parser = new DatabaseParser(); //Relevant towards parsing the database

        //parser.connect();
        //parser.nodeParse();
       // parser.floorTables(); //If you already have the NODE and the EDGE tables, only uncomment this line and run, else uncomment NODEPARSE and EDGEPARSE first and run
       // parser.edgeParse();
